...
public class ViewPagerOptions {
    ...
    fileprivate struct Color {
        ...
        static let textDefault = UIColor.from(r: 229.0, g: 0, b: 179)
        static let textHighlight = UIColor.from(r: 229.0, g: 0, b: 179)
        static let tabIndicator = UIColor.from(r: 229.0, g: 0, b: 179)
    }
}
