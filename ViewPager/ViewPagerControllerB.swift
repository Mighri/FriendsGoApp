...
public extension ViewPagerControllerDataSourceB {
...
public class ViewPagerControllerB:UIViewController {
    
    public weak var dataSource:ViewPagerControllerDataSourceB!
    public weak var delegate:ViewPagerControllerDelegateB?
    ...
    fileprivate var tabsViewList = [ViewPagerTabViewB]()
    
    fileprivate var isIndicatorAdded = false
    fileprivate var currentPageIndex = 0
    
    public var options:ViewPagerOptionsB!
    ...
    fileprivate func setupTabs() {
        ...
        if options.fitAllTabsInView {
            ...
            for (index,eachTab) in tabsList.enumerated() {
                ...
                let tabView = ViewPagerTabViewB()
                tabView.frame = CGRect(x: xPosition, y: 0, width: eachLabelWidth, height: options.tabViewHeight)
                tabView.setup(tab: eachTab, options: options, condition: ViewPagerTabViewB.SetupCondition.fitAllTabs)
            ...
            for (index,eachTab) in tabsList.enumerated() {
                ...
                tabView.setup(tab: eachTab, options: options, condition: ViewPagerTabViewB.SetupCondition.distributeNormally)
...
extension ViewPagerControllerB: UIPageViewControllerDelegate {
...
extension ViewPagerControllerB:UIPageViewControllerDataSource {
